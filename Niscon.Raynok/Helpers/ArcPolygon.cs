...
namespace Niscon.Raynok.Helpers
{
    public sealed class ArcPolygon : Shape
    {
        ...
        {
            ArcPointCollection points = PointCollection;
            ...
            if (points.Any())
            {
                ...
                if (points.Count > 1)
                {
                    ...
                    for (int i = 1; i < (points.Count - 1); i++)
                    {
                        ...
                        v1.Normalize();
                        v1 *= (len - radius);
                        LineSegment line = new LineSegment((Point)points[i - 1] + v1, true);
                        ...
                        ArcSegment arc = new ArcSegment((Point)points[i] + v2, new Size(radius, radius), 0, false, direction, true);
        ...
        public string Points
        {
            ...
            set
            {
                ArcPointCollection pointCollection = new ArcPointCollection();
                ...
                foreach (string point in points)
                {
                    ...
                    string[] xyarc = point.Split(',');
                    ArcPoint item = new ArcPoint();
