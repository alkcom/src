...
namespace Niscon.Raynok.Helpers
{
    public class RoundedCornersPolygon : Shape
    {
        ...
        private void AddPointToPath(Point currentPoint, Point? prevPoint, Point? prevPrevPoint)
        {
            ...
            {
                LineSegment lines = new LineSegment { Point = currentPoint };
        ...
        private void CloseFigure(PathFigure pathFigure)
        {
            ...
            QuadraticBezierSegment line2 = new QuadraticBezierSegment { Point1 = Points[0], Point2 = nextPoint };
        ...
        private static void ConnectLinePoints(PathFigure pathFigure, Point p1, Point p2, Point p3, double roundness, bool usePercentage)
        {
            ...
            QuadraticBezierSegment curve = new QuadraticBezierSegment { Point1 = p2, Point2 = nextPoint };
            pathFigure.Segments.Add(curve);
            //Create and add the new segment.
            LineSegment line = new LineSegment { Point = p3 };
